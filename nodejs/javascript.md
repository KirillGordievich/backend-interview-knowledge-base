...
- Циклические ссылки — но `JSON.stringify` на объекте с циклом кидает `TypeError: Converting circular structure to JSON`, не stack overflow (движок сам детектит цикл раньше, чем стек переполнится)
