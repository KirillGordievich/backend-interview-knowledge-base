...
### Как использовать несколько CTE в одном запросе

Через запятую можно объявить несколько CTE, и каждый следующий может ссылаться на предыдущий:
...
## Когда использовать CTE, подзапрос или временную таблицу
...
## Чем отличаются EXISTS, IN и JOIN
